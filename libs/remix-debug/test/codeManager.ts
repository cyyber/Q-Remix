...
tape('CodeManager', function (t) {
  ...
  const contractCode = web3Test.zond.getCode('0x0d3a18d64dfe4f927832ab58d6451cecc4e517c5')
  ...
  const tx = web3Test.zond.getTransaction('0x20ef65b8b186ca942fcccd634f37074dde49b541c27994fc7596740ef44cfd51')
