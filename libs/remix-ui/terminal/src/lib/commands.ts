...
export const allCommands = [
  ...
  { 'web3.zond': 'Eth module for interacting with the Ethereum network.' },
  { 'web3.zond.accounts': 'The web3.zond.accounts contains functions to generate Ethereum accounts and sign transactions and data.' },
  ...
  { 'web3.zond.Iban': 'The web3.zond.Iban function lets convert Ethereum addresses from and to IBAN and BBAN.' },
  { 'web3.zond.net': 'Net module for interacting with network properties.' },
  { 'web3.zond.personal': 'Personal module for interacting with the Ethereum accounts.' },
...
//   { 'web3.zond.Contract(jsonInterface[, address][, options])': 'The web3.zond.Contract object makes it easy to interact with smart contracts on the ethereum blockchain.' },
//   { 'web3.zond.accounts.create([entropy]);': 'The web3.zond.accounts contains functions to generate Ethereum accounts and sign transactions and data.' },
